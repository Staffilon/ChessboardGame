...
import it.unicam.cs.pa.ChessboardGame.Model.Movement.ManMovement;
...
public class ManMovementTest {
    ...
    public void shouldReturnFalseWhenCapturingKingPiece() {
        ...
        CheckersPiece piece = new CheckersPiece(CheckersColor.WHITE, CheckersPieceType.KING, true);
        board.setPieceAt(piece, inBetweenPosition);
    ...
    public void shouldBeAbleToCapture() {
        ...
        CheckersPiece piece = new CheckersPiece(CheckersColor.BLACK);
        board.setPieceAt(piece, inBetweenPosition);
        assertTrue(manMovement.canCapture(board, board.getSquareAt(fromPosition)));
    }
    ...
    public void shouldNotBeAbleToCapture() {
        ...
        CheckersPiece piece = new CheckersPiece(CheckersColor.WHITE);
        board.setPieceAt(piece, inBetweenPosition);
        assertFalse(manMovement.canCapture(board, board.getSquareAt(fromPosition)));

        CheckersPiece kingPiece = new CheckersPiece(CheckersColor.BLACK, CheckersPieceType.KING, true);

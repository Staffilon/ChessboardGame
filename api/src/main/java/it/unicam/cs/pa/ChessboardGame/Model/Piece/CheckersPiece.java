...
public class CheckersPiece implements Piece, Promotable {
     ...
     * @param pieceType       the piece type of the checkers piece
     * @param hasBeenPromoted true if the piece has been promoted, false otherwise
     */
    public CheckersPiece(CheckersColor color, CheckersPieceType pieceType, boolean hasBeenPromoted) {
        this.color = color;

 ...
 */
public class KingMovement implements PieceMovement<CheckersPosition, CheckersPiece, CheckersSquare, CheckersBoard> {
     ...
     */
    public boolean canCapture(CheckersBoard board, CheckersSquare square) {
